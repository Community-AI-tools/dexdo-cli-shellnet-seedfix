...
contract OrderBook is Modifiers {
    ...
    /// Each fill pays takerFee x MAKER_REBATE_NUM/MAKER_REBATE_DEN
    ...
    /// actions (2 extern events + 2 internal callbacks). 30 x 4 = 120
    /// leaves ample room for the worst-case executeBatch interleave
    /// (5 PLACE x validation/Queued/onOrderRejected actions + the
    ...
    /// Each cancel emits 2 actions; 30 x 2 = 60 with similar headroom.
