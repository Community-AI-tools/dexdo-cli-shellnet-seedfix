...
use crate::chain::order_deadline_is_live;
...
use crate::chain::{BuyerOrderFact, BuyerOrderFactKind};
...
pub(super) async fn read_book_fill_candidates(
    ...
    fetch_all_ext_out_messages(http, endpoint, account_id, move |message| {
...
mod tests {
    ...
    async fn event_fold_keeps_the_placements_own_flags() {
        let shaped = crate::chain::flags::AON | crate::chain::flags::SUBSCRIPTION;
        let folded = fold(vec![
